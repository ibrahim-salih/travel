                  ...
                  <span
                      class="user-name text-bold-700">  {{auth('admin') -> user() -> name}}</span>
                            ...
                            @if(auth('admin') -> user() -> image != '' ) 
                  			<img  style="height: 35px;" src="{{asset('assets/images/users')}}/{{auth('admin') -> user() -> image}}" alt="avatar"><i></i></span>
                  			@else
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">{{__('admin/header.read all notifications')}}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('assets/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">{{__('admin/header.read all messages')}}</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
